import { IDrawingContext, Position, Size, Tree } from "./common.js";
...
interface ILayoutTreeInfo {
    layoutTree: PositionedTree;
    maxNodeTextHeight: number;
    maxLabelTextHeight: number;
}

function prepareWorkspace(drawingContext: IDrawingContext, tree: Tree): ILayoutTreeInfo {
    function getLayoutTreeInfo(node: Tree): ILayoutTreeInfo {
...
function getLeftBoundary(node: PositionedTree, nodePaddingX: number): number {
...
export function drawTreeGraph(configuration: Configuration, drawingContext: IDrawingContext, tree: Tree): void {
